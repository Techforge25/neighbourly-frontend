...
const LocalsTrustMost = () => {
  return (
    <div className="max-w-[1260px] mx-auto rounded-[22px] overflow-hidden relative bg-share-modal-icon bg-[url('/images/findSectionBg.png')] bg-cover bg-center mb-12 min-h-[380px] sm:min-h-[480px] md:min-h-[592px]">
      {/* Text + Pills */}
      <div className="absolute left-4 sm:left-6 md:left-10 top-6 sm:top-10 md:top-16 z-10 max-w-full sm:max-w-[50%] md:max-w-[45%]">

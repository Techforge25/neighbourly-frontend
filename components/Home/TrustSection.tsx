  ...
  return (
    <main className="lg:max-w-[1296px] mx-auto md:my-10 p-6">
      <div className="">
        ...
        >
          <p className="font-manrope font-bold text-text-dark-secondary text-[1.5rem] sm:text-[2rem] md:text-[2.25rem] lg:text-[2.625rem] text-center leading-[2rem] sm:leading-[2.5rem] md:leading-[3rem] lg:leading-[3.25rem]">

...
const Find = () => {
  ...
  return (
    <div
      className={`bg-[${"#FE9A86"}] bg-[url('/images/find.png')] bg-cover bg-center min-h-[400px] sm:min-h-[450px] lg:h-[500px] flex items-center`}
    >
      <div className="container mx-auto px-4 py-12 sm:py-14 lg:py-16">
        <div className="w-full">
          ...
          {/* Description */}
          <p className="mt-4 text-[14px] sm:text-[15px] md:text-[16px] text-center text-white leading-relaxed sm:w-[80%] md:w-[60%] lg:w-[40%] font-poppins mx-auto">
          ...
          <div className="mt-6 flex items-center justify-center">
            <button
              ...
              className="flex items-center gap-3 cursor-pointer sm:gap-4 px-5 sm:px-6 py-3 sm:py-4 rounded-full bg-white text-[14px] sm:text-[16px] font-outfit"
            >

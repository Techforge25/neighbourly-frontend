...
const Across = () => {
  return (
    <section className="bg-green">
      <div className="md:w-[1441px] w-[90%] mx-auto md:h-[438px] md:py-[72px] py-[30px] md:px-[75px] px-[10px] ">
        <div className="">
          ...
          <div className="flex md:items-center md:flex-row flex-col md:justify-between justify-center md:mt-30 mt-4 md:gap-0 gap-4">
